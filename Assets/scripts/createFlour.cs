...
public class CreateFlour : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject Clone2 = Instantiate(FlourGameObj, new Vector3(this.transform.position.x + 0.2f, this.transform.position.y - 0.2f, this.transform.position.z), Quaternion.identity);
