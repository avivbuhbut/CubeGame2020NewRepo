...
public class MeshDestroy : MonoBehaviour
{
     ...
     void OnCollisionEnter(Collision collision)
    {
      ...
      //  if (collision.gameObject.tag == "Player" && counter < 10)
      //  {
        //    counter++;

         //   Distraction1 = true;
          //  coutnerHit++;
         //   this.transform.GetComponent<Rigidbody>().AddForce(new Vector3(collision.transform.position.x * 10f,0 , 0),ForceMode.Impulse);
         //   DestroyMesh(this.transform.gameObject.GetComponent<MeshFilter>().mesh, this.transform.GetComponent<MeshDestroy>(), this.gameObject);
        //}
