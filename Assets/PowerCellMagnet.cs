...
public class PowerCellMagnet : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.transform.name == "PowerCircle(Clone)") // change accordint to needs
        {
    ...
    {
        if (other.gameObject.transform.name == "PowerCircle(Clone)")
