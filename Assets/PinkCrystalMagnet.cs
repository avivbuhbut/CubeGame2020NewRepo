...
public class PinkCrystalMagnet : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.transform.name == "TimeCrystalPink(Clone)") // change accordint to needs
        {
    ...
    {
        if (other.gameObject.transform.name == "TimeCrystalPink(Clone)")
