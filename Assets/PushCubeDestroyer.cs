...
public class PushCubeDestroyer : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.transform.tag == "CubeDestroyer") // change accordint to needs
        {
    ...
    {
        if (other.gameObject.transform.tag == "CubeDestroyer")
